/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 1ebafd9ad039ceaad295236bee4489bf)
// Runtime types generated with workerd@1.20260401.1 2026-04-03 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./dist/index");
		durableNamespaces: "StockManager" | "LiveChat";
	}
	interface Env {
		DB: D1Database;
		...
		AI: Ai;
		ASSETS: Fetcher;
		JWT_SECRET: "JFVDBTaLWKvbsfM9cJMk7LrvvRWPQaSY";
		STOCK_MANAGER: DurableObjectNamespace<import("./dist/index").StockManager>;
		LIVE_CHAT: DurableObjectNamespace<import("./dist/index").LiveChat>;
		ORDER_FULFILLMENT: Workflow<Parameters<import("./dist/index").OrderFulfillment['run']>[0]['payload']>;
		REFUND_WORKFLOW: Workflow<Parameters<import("./dist/index").RefundWorkflow['run']>[0]['payload']>;
	}
}
