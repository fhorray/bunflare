/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 61c6470ac422951bb11c715221b266bc)
// Runtime types generated with workerd@1.20250730.0 2024-04-03 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		CART_SESSION: DurableObjectNamespace<import("./dist/index").CartSession>;
		LIVE_INVENTORY: DurableObjectNamespace<import("./dist/index").LiveInventory>;
		BROWSER: Fetcher;
		ASSETS: Fetcher;
		ORDER_PROCESSING_WORKFLOW: Workflow;
		ANALYTICS_EXPORT_WORKFLOW: Workflow;
	}
}
