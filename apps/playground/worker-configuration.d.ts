/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 370bd97ef49bdd309f111d324b7fe648)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		DB: D1Database;
		ASSETS: Fetcher;
		APP_NAME: "Playground App from Bun Environment";
		COUNTER: DurableObjectNamespace<import("./dist/index").Counter>;
		PROCESSING_WORKFLOW: Workflow<Parameters<import("./dist/index").ProcessingWorkflow['run']>[0]['payload']>;
	}
}
