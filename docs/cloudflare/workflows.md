...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "item": { "@id": "/workflows/", "name": "Workflows" }
    }
  ]
}
```
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "item": { "@id": "/workflows/python/", "name": "Python Workflows SDK" }
    }
  ]
}
```
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "item": {
        "@id": "/workflows/python/bindings/",
        "name": "Interact with a Workflow"
      }
    }
  ]
}
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 4,
      "item": { "@id": "/workflows/python/dag/", "name": "DAG Workflows" }
    }
  ]
}
```
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "item": {
        "@id": "/workflows/python/python-workers-api/",
        "name": "Python Workers API"
      }
    }
  ]
}
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "item": { "@id": "/workflows/videos/", "name": "Videos" }
    }
  ]
}
```
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "item": { "@id": "/workflows/examples/", "name": "Examples" }
    }
  ]
}
```
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 4,
      "item": { "@id": "/workflows/examples/agents/", "name": "Agents" }
    }
  ]
}
```
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "item": {
        "@id": "/workflows/examples/backup-d1/",
        "name": "Export and save D1 database"
      }
    }
  ]
}
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "item": {
        "@id": "/workflows/examples/send-invoices/",
        "name": "Pay cart and send invoice"
      }
    }
  ]
}
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "item": {
        "@id": "/workflows/examples/twilio/",
        "name": "Integrate Workflows with Twilio"
      }
    }
  ]
}
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "item": {
        "@id": "/workflows/examples/wait-for-event/",
        "name": "Human-in-the-Loop Image Tagging with waitForEvent"
      }
    }
  ]
}
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "item": {
        "@id": "/workflows/workflows-api/",
        "name": "Workflows REST API"
      }
    }
  ]
}
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "item": { "@id": "/workflows/build/", "name": "Build with Workflows" }
    },
    {
      "@type": "ListItem",
      "position": 4,
      "item": {
        "@id": "/workflows/build/call-workflows-from-pages/",
        "name": "Call Workflows from Pages"
      }
    }
  ]
}
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "item": {
        "@id": "/workflows/build/events-and-parameters/",
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "item": {
        "@id": "/workflows/build/local-development/",
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "item": {
        "@id": "/workflows/build/rules-of-workflows/",
        "name": "Rules of Workflows"
      }
    }
  ]
}
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "item": {
        "@id": "/workflows/build/sleeping-and-retrying/",
        "name": "Sleeping and retrying"
      }
    }
  ]
}
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "item": {
        "@id": "/workflows/build/test-workflows/",
        "name": "Test Workflows"
      }
    }
  ]
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "item": {
        "@id": "/workflows/build/trigger-workflows/",
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 4,
      "item": { "@id": "/workflows/build/workers-api/", "name": "Workers API" }
    }
  ]
}
```
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "item": { "@id": "/workflows/get-started/", "name": "Get started" }
    },
    {
      "@type": "ListItem",
      "position": 4,
      "item": {
        "@id": "/workflows/get-started/durable-agents/",
        "name": "Build a Durable AI Agent"
      }
    }
  ]
}
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "item": {
        "@id": "/workflows/get-started/guide/",
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "item": { "@id": "/workflows/observability/", "name": "Observability" }
    },
    {
      "@type": "ListItem",
      "position": 4,
      "item": {
        "@id": "/workflows/observability/metrics-analytics/",
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "item": { "@id": "/workflows/reference/", "name": "Platform" }
    },
    {
      "@type": "ListItem",
      "position": 4,
      "item": { "@id": "/workflows/reference/changelog/", "name": "Changelog" }
    }
  ]
}
```
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "item": {
        "@id": "/workflows/reference/event-subscriptions/",
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 4,
      "item": { "@id": "/workflows/reference/glossary/", "name": "Glossary" }
    }
  ]
}
```
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 4,
      "item": { "@id": "/workflows/reference/limits/", "name": "Limits" }
    }
  ]
}
```
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 4,
      "item": { "@id": "/workflows/reference/pricing/", "name": "Pricing" }
    }
  ]
}
```
...
```json
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "item": {
        "@id": "/workflows/reference/wrangler-commands/",
